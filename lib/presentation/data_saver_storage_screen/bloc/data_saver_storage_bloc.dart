import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application28/presentation/data_saver_storage_screen/models/data_saver_storage_model.dart';part 'data_saver_storage_event.dart';part 'data_saver_storage_state.dart';class DataSaverStorageBloc extends Bloc<DataSaverStorageEvent, DataSaverStorageState> {DataSaverStorageBloc(DataSaverStorageState initialState) : super(initialState) { on<DataSaverStorageInitialEvent>(_onInitialize); on<ChangeSwitchEvent>(_changeSwitch); on<ChangeSwitch1Event>(_changeSwitch1); on<ChangeSwitch2Event>(_changeSwitch2); }
